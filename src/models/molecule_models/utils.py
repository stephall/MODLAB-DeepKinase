# models/molecule_models/utils.py
...
def define_model(config_dict):
    ...
    try:
        ...
        err_msg = f"The combination model with name '{config_dict['name']}' is not defined in the file 'molecule_model/model_definitions.py'."
